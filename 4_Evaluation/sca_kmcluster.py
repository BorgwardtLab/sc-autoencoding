...
plt.grid()
plt.show()
plt.savefig(outputplot_dir + title + "_clusterplot_prediction.png")
...
ax.grid()
plt.savefig(outputplot_dir + title + "_truelabel_plot.png")
...
plt.grid()
plt.show()
plt.savefig(outputplot_dir + title + "_clusterplot_mistakes.png")
...
plt.savefig(outputplot_dir + title + "_cluster_histogram.png")
