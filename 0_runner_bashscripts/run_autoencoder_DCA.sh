...
python ../4_Evaluation/sca_classification.py --reset --title "DCA" --kfold 5 --classifier $classifier --input_dir "../inputs/sca/DCA_output/" --output_dir "../outputs/sca/dca/ova_classification/" |& tee -a log_run_autoencoder_DCA.log
