...
#minpts=(002 003 004 005 008 010 020 060 030 040 050 080 090 100 150 200 250 300) # combined
#minpts=(090 100 150 200 250 300) # combined
...
# complete
eps=(004 005 006 007 008 009 010 012 015 020 025 030 035 040 050 100 300)
minpts=(400 500 600 700 800 900 999)
