...
python ../3_Autoencoder/sca_autoencoder_poisson_loss.py --input_dir "../inputs/sca/sca_preprocessed_data/" --output_dir $ae_outdir |& tee -a $filename
...
echo "I have finished running the POISSONLOSS autoencoder"
