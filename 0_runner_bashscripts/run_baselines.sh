...
python ../4_Evaluation/sca_classification.py --title "original_data" --kfold 5 --classifier "logreg" --input_dir "../inputs/data/preprocessed_data/" --output_dir "../outputs/baselines/outputs/original_data/" |& tee -a log_run_baselines.log
