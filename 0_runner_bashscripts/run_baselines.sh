...
python ../2_Baseline_Scripts/sca_Isomap.py --num_components 50 --input_dir "../inputs/preprocessed_data/" --output_dir "../inputs/baseline_data/scaIsomap_output/" --outputplot_dir "../outputs/baseline_data/scaIsomap_output/" |& tee -a run_all.log
...
python ../1_Main_Scripts/sca_kmcluster.py --title "original_data" --k 5 --dimensions 0 --verbosity 0 --input_dir "../inputs/preprocessed_data/" --output_dir "../outputs/kmcluster/" --outputplot_dir "../outputs/kmcluster/original_data/" |& tee -a run_all.log
