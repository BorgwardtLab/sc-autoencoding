...
python ../3_Autoencoder/sca_autoencoder.py --mode complete --AEtype normal --loss poisson_loss --input_dir "../inputs/data/preprocessed_data_autoencoder/" --output_dir "../inputs/autoencoder_data/SCA_output/" --outputplot_dir "../outputs/autoencoder_data/SCA/" |& tee -a $logfile
