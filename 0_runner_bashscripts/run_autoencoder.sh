...
python ../4_Evaluation/sca_classification.py --reset --title "SCAutoencoder" --kfold 5 --classifier "logreg" --input_dir "../inputs/sca/autoencoder_output/" --output_dir "../outputs/sca/ova_classification/" |& tee -a log_run_autoencoder.log
