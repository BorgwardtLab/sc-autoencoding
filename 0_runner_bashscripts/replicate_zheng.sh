...
python ../3_Autoencoder/sca_autoencoder_2neck.py --mode nosplit --loss poisson_loss --AEtype 'zinb-fork' --input_dir "../outputs/experiments/replication_zheng/preprocessed/" --output_dir "../outputs/experiments/replication_zheng/AE_output/" --outputplot_dir "../outputs/experiments/replication_zheng/AE_output/" |& tee -a $logfile
...
# zinb shared
    ...
    #         '': ZINBSharedAutoencoder, 'zinb-fork': ZINBForkAutoencoder,
