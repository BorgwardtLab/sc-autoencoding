...
parser.add_argument("--AEtype", default = "zinb-conddisp", choices=['normal','poisson','nb','nb-shared','nb-conddisp','nb-fork','zinb-shared','zinb-elempi','zinb-conddisp','zinb-fork'])
