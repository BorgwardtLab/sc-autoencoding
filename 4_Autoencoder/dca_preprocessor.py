...
parser.add_argument("-o","--output_dir", help="output directory", default = "../inputs/dca_preprocessed_data/")
parser.add_argument("-p","--outputplot_dir", help="plot directory", default = "../outputs/preprocessed_data/dca_preprocessing/")
